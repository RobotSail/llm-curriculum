...
export const hardModule = {
  ...
  steps: [
    ...
    },
    {
      ...
      options: [
        "A numerical precision error in the weight initialization",
        "A direction in weight space that has learned structured signal (not random noise)",
        "That the matrix is rank-deficient",
        "That the learning rate was too large"
      ],
      correct: 1,
    ...
    },
    {
      ...
      options: [
        "All singular values equally",
        "The smallest singular values (near 1), since there are more of them",
        "The largest singular values, since they contribute most to $\\|W\\|_F^2$",
        "Weight decay has no effect on the singular value spectrum"
      ],
      correct: 2,
