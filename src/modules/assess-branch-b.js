...
export const architectureAssessment = {
  ...
  steps: [
    ...
    },
    {
      ...
      options: [
        "Different layers use different hidden dimensions to save compute",
        ...
        "The model has a variable number of layers that changes during training",
        "Attention heads at deeper layers are pruned to reduce compute"
      ],
      correct: 1,
...
export const trainingDynamicsAssessment = {
  ...
  steps: [
    ...
    },
    {
      ...
      options: [
        "Whether the model uses convolutional or attention-based features",
        ...
        "Whether features are learned in supervised or unsupervised fashion",
        "Whether the kernel function is Gaussian (RBF) or polynomial"
      ],
      correct: 1,
    ...
    },
    {
      ...
      options: [
        "Attending to the first token in the sequence to ground predictions",
        ...
        "Computing the average of all previous token embeddings",
        "Attending to the most semantically similar token in the context"
      ],
      correct: 1,
    ...
    },
    {
      ...
      options: [
        "Hardware failures causing corrupted gradients",
        ...
        "The training data containing adversarial examples",
  ...
  steps: [
    {
      ...
      options: [
        "Both model the exact same joint distribution, just with different factorizations",
        ...
        "MLM defines the joint distribution more efficiently because it processes all tokens in parallel",
        "Autoregressive models can only generate text, while MLM can both generate and understand"
      ],
      correct: 1,
    ...
    },
    {
      ...
      options: [
        "They require more parameters than autoregressive models",
        ...
        "They cannot use the Transformer architecture",
        "They are slower than autoregressive models in practice"
      ],
      correct: 1,
    ...
    },
    {
      ...
      options: [
        "More steps always produces worse results due to error accumulation",
        ...
        "The number of steps does not affect output quality, only speed",
        "Discrete diffusion requires exactly 1000 steps to work correctly"
      ],
      correct: 1,
